...
class PlaylistsTestCase(unittest.TestCase):
    ...
    def test_new_playlists(self):
        ...
        self.assertEqual(json.loads(response.data), {'id':'ps'})
    ...
    def test_update_playlists(self):
        ...
        self.assertEqual(json.loads(response.data), {'updated':'ps'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete(self):
        ...
        self.assertEqual(json.loads(response.data), {'deleted':'ps'})
        self.assertEqual(response.status_code, 200)
